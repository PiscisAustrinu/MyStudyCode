...
<body>
	...
	<div id="header">
			...
			<span class="wel_word">惠民农产品交易平台</span>
			<div>
...
<%--				如果已经成功登录，则显示登录成功后的用户信息。--%>
				<c:if test="${not empty sessionScope.user}">
					<span>欢迎<span class="um_span">${sessionScope.user.username}</span>光临惠民平台</span>
				...
				<div class="b_list">
					...
					<div class="book_info">
						...
						<div class="book_author">
							<span class="sp1">原产地:</span>
							<span class="sp2">${book.author}</span>
						</div>
						<div class="book_price">
							<span class="sp1">价格:</span>
							<span class="sp2">￥${book.price}</span>
							<span class="sp1">/斤</span>
						</div>
