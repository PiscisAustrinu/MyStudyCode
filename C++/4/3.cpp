...
void AdjMatrix(unsigned int adjMat[][vexCounts])  //邻接矩阵表示法
{
    ...
    adjMat[0][1] = 1; adjMat[0][2] = 6; adjMat[0][3] = 2;
    adjMat[1][0] = 1; adjMat[1][2] = 7; adjMat[1][3] = 2;
    adjMat[2][0] = 6; adjMat[2][1] = 7; adjMat[2][3] = 9; adjMat[2][4] = 4; adjMat[2][5] = 3;
    adjMat[3][0] = 2; adjMat[3][1] = 2; adjMat[3][2] = 9; adjMat[3][4] = 7; adjMat[3][5] = 6;
    adjMat[4][2] = 4; adjMat[4][3] = 7; adjMat[4][5] = 3;
    adjMat[5][2] = 3; adjMat[5][3] = 6; adjMat[5][4] = 3;
}
